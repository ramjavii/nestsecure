...
# Usamos la URL sync para Alembic (las migraciones son síncronas)
...
def run_sync_migrations() -> None:
    """
    Ejecuta migraciones de forma síncrona.
    
    Crea un engine síncrono y ejecuta las migraciones
    dentro del contexto de conexión.
    """
